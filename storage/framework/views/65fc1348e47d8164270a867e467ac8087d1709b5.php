...
<div class="tocify-wrapper">
    ...
    <ul class="toc-footer" id="toc-footer">
        <?php if($metadata['postman_collection_url']): ?>
            <li style="padding-bottom: 5px;"><a href="<?php echo $metadata['postman_collection_url']; ?>">View Postman collection</a></li>
        <?php endif; ?>
        <?php if($metadata['openapi_spec_url']): ?>
            <li style="padding-bottom: 5px;"><a href="<?php echo $metadata['openapi_spec_url']; ?>">View OpenAPI spec</a></li>
        <?php endif; ?>
...
<?php /**PATH D:\projects\personal projects\task-management-app\vendor\knuckleswtf\scribe\src/../resources/views//themes/default/sidebar.blade.php ENDPATH**/ ?>